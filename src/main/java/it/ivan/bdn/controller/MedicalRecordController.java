...
import it.ivan.bdn.model.*;
import it.ivan.bdn.repository.*;
...
public class MedicalRecordController {
    ...
    @GetMapping("/")
    public ResponseEntity<List<MedicalRecord>> listAllSchede() {
        List<MedicalRecord> schede = medicalRecordRepository.findAll();
        if (schede.isEmpty()) {
            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
        }
        return new ResponseEntity<>(schede, HttpStatus.OK);
    }
