INSERT INTO bdn_db.roles
VALUES (1, 'ADMIN'),
       (2, 'USER');
SELECT setval('bdn_db.roles_id_seq', (SELECT max(id) FROM bdn_db.roles));


INSERT INTO bdn_db.hospital
VALUES (1, 'mav123', 'Moscati (Avellino)'),
       (2, 'can123', 'Cardarelli (Naples)'),
       (3, 'san123', 'Santobono (Naples)');
...
-- admin@admin.co: psw: admin
-- user@user.com: psw: user
INSERT INTO bdn_db.users (id, email, first_name, hospital_code, last_name, password, role, username)
VALUES (1, 'admin@admin.com', 'admin', 'mav123', 'admin',
        '$2a$10$ANn8FaVd4LMjO6OybxGHHuLYj7Xa9nVa..mqRUPkLk4/gLhj/HQNq', 'ADMIN', 'admin'),
       (2, 'user@user.com', 'user', 'mav123', 'user', '$2a$10$mHUQt0sUv10//5Aqk/zGT.I9lWKbQpPLUzBtLYZQ/I4QcL/TBr87i',
        'USER', 'user');
SELECT setval('bdn_db.users_id_seq', (SELECT max(id) FROM bdn_db.users));